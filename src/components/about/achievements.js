    ...
    <div>
      <div className="container achievements">
        <div className="col-md-7">
          ...
          <ul>
            <li>
              Bagged <a href="https://codingcompetitions.withgoogle.com/hashcode/certificate/summary/0000000000435809">346</a> AIR (World Rank: 1835) in Google Hashcode 2021 out of
              7200+ teams.
            </li>
            <li>
            ...
            <li>Maximum Rating on CodeChef: <a href="https://www.codechef.com/users/rhythm_28">1709</a> (3 star).</li>
            <li>5 stars in Problem Solving on Hacker Rank.</li>
            <li>5 stars in C++ on Hacker Rank.</li>
            <li>Reached <a href="https://www.hackerrank.com/certificates/3c9aa3ade860">Intermediate</a> Level in C on Hacker Rank.</li>
          </ul>
        </div>
        <div className="codingProfiles col-md-5">
          ...
          <div className="profiles">
            <div>
              ...
              &nbsp;&nbsp;&nbsp;
              <h5><a href="https://www.codechef.com/users/rhythm_28">rhythm_28</a></h5>
            </div>
            <div>
              <Avatar src={hackerRank} sx={{ width: "40px", height: "40px" }} />
              &nbsp;&nbsp;&nbsp;
              <h5><a href="https://www.hackerrank.com/rhythm_28">rhythm_28</a></h5>
            </div>
          </div>
          <br />
          <br />
